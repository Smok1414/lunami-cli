...
export async function searchCode(pattern, path = '.') {
...
async function tryRipgrep(pattern, cwd) {
...
async function nodeSearch(pattern, root) {
    const matches = [];
    let truncated = false;
...
function formatMatches(lines, cwd) {
