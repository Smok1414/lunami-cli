...
const undoStack = [];
export function agentSkipsApprovals(mode) {
    return mode === 'yolo';
}
 ...
 */
export async function changeCwd(target) {
...
export class PathOutsideWorkspaceError extends Error {
    ...
    workspaceRoot;
    currentCwd;
    constructor(inputPath, workspaceRoot, currentCwd) {
        super(`Path outside workspace is not allowed: ${inputPath}\n` +
...
function isPathInsideWorkspace(root, target) {
 ...
 */
export function setPendingApproval(approval) {
    pendingApproval = {
        ...approval,
 ...
 */
export async function writeProjectContext(content) {
 ...
 */
export async function appendProjectContext(text) {
