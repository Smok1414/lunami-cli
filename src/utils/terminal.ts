 ...
 */
export function prefersAsciiOutput(): boolean {
...
export function asciiFallback(unicodeText: string, asciiText: string): string {
  return prefersAsciiOutput() ? asciiText : unicodeText;
}

export function prepareTerminalEncoding(): void {
