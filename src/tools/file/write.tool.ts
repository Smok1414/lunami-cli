...
export class WriteTool implements ITool {
  ...
  public readonly description = 'Write UTF-8 text content to a file in the current project workspace. Creates parent folders if needed.';
  ...
  private createMiniDiff(path: string, oldContent: string, newContent: string, isNew: boolean): string[] {
